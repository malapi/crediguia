...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private static final String[] DUMMY_CREDENTIALS = new String[]{
            "28272137:malapi", "22664811:113519"
    };
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button mEmailRegistrarseButton = (Button) findViewById(R.id.email_registrarse_button);
        mEmailRegistrarseButton.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                // attemptLogin();
               // Intent intent = new Intent(LoginActivity.this, ScrollingActivity.class);
               // Intent intent = new Intent(LoginActivity.this, CompraListActivity.class);
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            new LoginRestClient(null, LoginActivity.this).execute(parametros);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                Intent intent = new Intent(LoginActivity.this, UsuarioLogueadoActivity.class);
                Bundle info = new Bundle();
                intent.putExtras(info);
                startActivity(intent);
